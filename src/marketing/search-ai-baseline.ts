...
export const searchAiBaselineRows: readonly SearchAiBaselineRow[] = [
  ...
  },
  {
    ...
    expectedTerms: ["QuickFork", "GitHub repository", "launch package", "source-backed", "README", "social", "deck", "outreach"],
    forbiddenClaims: allForbiddenClaims,
    decisionUse: "compare generic launch-package category demand against cold-start launch-materials demand",
  },
  {
    ...
    forbiddenClaims: allForbiddenClaims,
    decisionUse: "check whether full launch-materials intent is visible and accurately described",
  },
  {
    ...
    forbiddenClaims: allForbiddenClaims,
    decisionUse: "compare full launch-materials category demand against channel-map planning demand",
  },
  {
    ...
    forbiddenClaims: allForbiddenClaims,
    decisionUse: "check whether AI answers explain the source-backed channel map without inventing proof",
  },
];
